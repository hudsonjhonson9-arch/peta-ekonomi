    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 700, color: "#0F172A", letterSpacing: -0.3 }}>ARSIP DIGITAL BAPPERIDA</div>
          <div style={{ fontSize: 12, color: "#666", marginTop: 4 }}>
            Pusat Dokumen Digital Perencanaan Pembangunan
          </div>
        ...
        <button
          ...
          style={{
            ...
            background: loading ? "#999" : "linear-gradient(135deg, #2563EB, #1D4ED8)",
