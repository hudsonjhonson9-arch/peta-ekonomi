...
const CONTENT = {
  login: {
    ...
    steps: [
      ...
      "Masukkan <b>Password</b> (default: <code>admin123</code>)",
    ...
    screenshot: "Halaman Login dengan daftar akun"
  },
  dashboard: {
    title: "Dashboard",
    ...
    screenshot: "Tampilan Dashboard dengan statistik, grafik, bank data, dan dokumen terbaru"
  },
  dokumen: {
    title: "Dokumen",
    ...
    screenshot: "Tampilan Daftar Dokumen dengan filter"
  },
  detail: {
    ...
    screenshot: "Tampilan Detail Dokumen dengan tombol aksi"
  },
  upload: {
  ...
  pencarian: {
    ...
    screenshot: "Halaman Pencarian dengan hasil"
  },
  publik: {
    title: "Portal Publik",
  ...
  bankdata: {
    ...
    screenshot: "Halaman Bank Data dengan daftar indikator"
  },
  pengguna: {
    ...
    screenshot: "Halaman Manajemen Pengguna"
  },
  kategori: {
    ...
    screenshot: "Halaman Manajemen Kategori Dokumen"
  },
  audit: {
    ...
    screenshot: "Halaman Audit Trail"
  },
  trouble: {
  ...
  return (
    <div>
      ...
      <div style={{ background: "#fff", borderRadius: 12, padding: isMobile ? 16 : 24, border: "1px solid #e8e8e8" }}>
        ...
        {section.screenshot && (
          <div style={{ background: "#EFF6FF", borderRadius: 8, padding: "24px 16px", fontSize: 12, color: "#666", textAlign: "center", border: "1px dashed #BFDBFE", marginTop: 8 }}>
