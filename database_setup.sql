-- ============================================================
-- ARSIP DIGITAL BAPPERIDA — PostgreSQL Schema Updates
-- Jalankan di pgAdmin4: Tools → Query Tool → paste → F5
-- ============================================================

-- ── Kolom publik untuk bapperida_dokumen ────────────────────────────────────
-- Menandai dokumen yang dipublikasikan ke portal publik.
ALTER TABLE bapperida_dokumen
  ADD COLUMN IF NOT EXISTS publik BOOLEAN DEFAULT false;
